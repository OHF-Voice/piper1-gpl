...
2- extarct zip file ther : 

[piper-tts-cli-1.0.deb.zip](https://github.com/user-attachments/files/21305252/piper-tts-cli-1.0.deb.zip)

apt install -f ./piper-tts-cli-termux.deb
