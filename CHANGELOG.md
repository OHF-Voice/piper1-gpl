...
- Add Lithuanian phonemizer using espeak-ng plus a pitch accent dictionary
    ...
    - The stress dictionary (3 MB, CC-BY-4.0) ships with piper as package data, like the Hebrew model: pip install, download the voice, it works - no extra files and no new dependency
